...
<footer class="main-footer">
    ...
    <section class="footer-bottom">
        <div class="container">
            ...
            <div class="pull-left copy-text footer-layout">
                ...
                <div class="footer-contact">
                    ...
                    <p>Contact us to arrange a booking or a visit: <br>
                        <a href="mailto:morleyvillageandsportshall@gmail.com"> <i
                                class="far fa-envelope"></i>morleyvillageandsportshall@gmail.com</a>
                    </p>
                    <p>
                        <a href="tel:01953433699"><i class="fas fa-phone-square-alt"></i>01953 433699</a>
                    </p>
                    <address>
            ...
            <h3>Our Sponsors, Funders & Partners </h3>
        
            <div class="footer-sponsor">
                <div class=background-sponsor>
                    <img src="\wp-content\themes\fortun-child\img\CAN.jpg" alt="Community Action Norfolk"
                        class="sponsor">
                </div>
                <div class=background-sponsor>
                    <img src="\wp-content\themes\fortun-child\img\SAFFRON.jpg" alt="Saffron Community Foundation"
                        class="sponsor">
                </div>
                <div class=background-sponsor>
                    <img src="\wp-content\themes\fortun-child\img\visitEngland.jpg" alt="Visit England Logo"
                        class="sponsor" />
                </div>
                <div class=background-sponsor>
                    <img src="\wp-content\themes\fortun-child\img\lottery.jpeg" alt="Lottery-Founded" class="sponsor">
                </div>
                <div class=background-sponsor>
                    <img src="\wp-content\themes\fortun-child\img\South Norfolk Council Logo.png"
                        alt="South Norfolk Council" class="sponsor-long">
                </div>
                <div class=background-sponsor>
